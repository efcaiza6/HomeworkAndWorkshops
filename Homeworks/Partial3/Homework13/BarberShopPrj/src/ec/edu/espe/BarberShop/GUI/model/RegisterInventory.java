 ...
 * @author Byron
 */
public class RegisterInventory extends javax.swing.JFrame {

    /**
     * Creates new form RegisterInventory
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterInventory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterInventory().setVisible(true);
            }
        });
    }
